...
class Post
{
     ...
     */
    #[ORM\OneToMany(targetEntity: UserLike::class, mappedBy: 'post', orphanRemoval: true)]
    private Collection $userLikes;

    /**
     * @var Collection<int, UserComment>
     */
    #[ORM\OneToMany(targetEntity: UserComment::class, mappedBy: 'post', orphanRemoval: true)]
